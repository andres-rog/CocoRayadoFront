...
function CreatedRecipesBrowser({type="recipes"}) {
    ...
    async function getInitData(){
        ...
        const browseRecipesPromise = () => browseRecipes({title:"", tags:[], ingredients:[], type:"myRecipes"});
...
export default CreatedRecipesBrowser;